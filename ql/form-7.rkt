...
(define-syntax-parser form-clause*
  [(_ form-name guard-expr [local-id:id label:str widget-type calculated-field-fn-or-false])
   #'(begin
...
(define-syntax (when* stx)
  (raise-syntax-error #f "when not allowed here" stx))
